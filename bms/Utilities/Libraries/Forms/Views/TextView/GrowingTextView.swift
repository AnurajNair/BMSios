...
//  Forked from: https://github.com/KennethTsang/GrowingTextView
...
open class GrowingTextView: UITextView {
    ...
    override open func layoutSubviews() {
        ...
        else if height != heightConstraint?.constant {
            shouldScrollAfterHeightChanged = true
            heightConstraint!.constant = height
            
            if let delegate = delegate as? GrowingTextViewDelegate, shouldUpdateHeight {
    ...
    override open func point(inside point: CGPoint, with event: UIEvent?) -> Bool {
        return self.shouldDetectTouches
    }
}
