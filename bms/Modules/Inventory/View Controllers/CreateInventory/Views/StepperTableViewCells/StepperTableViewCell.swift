...
class StepperTableViewCell: UITableViewCell {
    ...
    private func getFormForStep( _ step: Int, inventory: Inventory) -> StepperTableViewCellFormProtocol? {
        ...
        case 7:
            form = Step7Form(inventory: inventory)

        case 8:
            form = Step8Form()

        case 9:
            form = Step9Form(inventory: inventory)

        case 10:
            form = Step10Form(inventory: inventory)

        case 11:
            form = Step11Form(inventory: inventory)
        ...
        case 16:
            form = Step16Form(inventory: inventory)
